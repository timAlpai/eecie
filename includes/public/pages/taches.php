<h2>Mes tâches</h2>
<div id="gce-taches-table" style="margin-top:1em;">Chargement…</div>
<?php
...
wp_enqueue_script('gce-taches-js', plugin_dir_url(__FILE__) . '../assets/js/taches.js', ['eecie-crm-rest','tabulator-js','gce-tabulator-editors','gce-tabulator-columns'], GCE_VERSION, true);

$current_user = wp_get_current_user();
wp_localize_script('gce-taches-js', 'GCE_CURRENT_USER', [
