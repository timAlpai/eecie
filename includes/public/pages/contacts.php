<h2>📇 Mes contacts</h2>
<div id="gce-contacts-table" style="margin-top:1em;">Chargement…</div>
...
wp_enqueue_script('gce-contacts-js', plugin_dir_url(__FILE__) . '../assets/js/contacts.js', ['eecie-crm-rest', 'tabulator-js', 'gce-tabulator-editors', 'gce-tabulator-columns'], GCE_VERSION, true);

$current_user = wp_get_current_user();
wp_localize_script('gce-contacts-js', 'GCE_CURRENT_USER', [
